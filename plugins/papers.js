...
let react = await conn.sendMessage(from, { document: { url: `https://github.com/MR-DARK-SHADOW/AL-PAST-PAPERS-DB/blob/main/2016-OL-Maths-Past-Paper-and-Answers-Sinhala-Medium.pdf?raw=` }, mimetype: "application/pdf", fileName: `ගණිතය_2016.pdf`, caption: `> *Have a nice day* 🌝❤️\n\n_© 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈 𝙳𝙰𝚁𝙺 𝚂𝙷𝙰𝙳𝙾𝚆_` }, { quoted: mek  })
